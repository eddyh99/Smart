<div class="card mb-0">
    <div class="card-body">
        <a href="" class="text-nowrap logo-img text-center d-block py-3 w-100">
            <img src="<?= base_url()?>assets/img/logo.png" width="180" alt="" data-aos="flip-left" data-aos-duration="2000">
        </a>
        <form action="<?= base_url()?>auth/auth_login" method="POST">
            ...
            <button type="submit" class="btn btn-danger w-100 py-8 fs-4 mb-4 rounded-2">Login</button>
        </form>
    </div>
</div>
<script>
