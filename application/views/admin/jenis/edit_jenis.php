        ...
        <div class="col-lg-12 d-flex align-items-strech">
            <div class="card w-100">
                <div class="card-body">
                    ...
                    <?php } ?>
                    <h5 class="card-title fw-semibold mb-4 text-decoration-underline">Edit Jenis Produk</h5>
                    <form action="<?= base_url()?>jenis/editjenis_proses" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Masukan Nama Jenis Produk..." value="<?=$jenis->jenis?>" required>
                        </div>
